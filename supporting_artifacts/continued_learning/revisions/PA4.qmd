...
military_clean <- military_clean |> 
  anti_join(x = military_clean, y = cont_region, by = c("Country" = "Region"))
```
...
**4. Pivot the cleaned up `military` dataset to a "longer" orientation. Save this new "long" version as a new dataset.**
